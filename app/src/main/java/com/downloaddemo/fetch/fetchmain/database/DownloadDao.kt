...
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_CREATED
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_FILE
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_GROUP
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_ID
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_IDENTIFIER
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_PRIORITY
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_STATUS
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.COLUMN_TAG
import com.downloaddemo.fetch.fetchmain.database.DownloadDatabase.Companion.TABLE_NAME
...
interface DownloadDao {
    ...
    fun getByGroupWithStatus(
        group: Int, statuses: List<@JvmSuppressWildcards Status>
    ): List<DownloadInfo>
