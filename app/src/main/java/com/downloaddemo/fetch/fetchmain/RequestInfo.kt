...
open class RequestInfo : Serializable {
    ...
    override fun toString(): String {
        return "RequestInfo(identifier=$identifier, groupId=$groupId," + " headers=$headers, priority=$priority, networkType=$networkType," + " tag=$tag, enqueueAction=$enqueueAction, downloadOnEnqueue=$downloadOnEnqueue, " + "autoRetryMaxAttempts=$autoRetryMaxAttempts, extras=$extras)"
    }
