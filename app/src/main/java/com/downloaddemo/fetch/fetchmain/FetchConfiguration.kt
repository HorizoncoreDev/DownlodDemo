...
import com.downloaddemo.fetch.fetchmain.FetchConfiguration.Builder
...
import com.downloaddemo.fetch.fetchmain.fetch.FetchHandler
...
class FetchConfiguration private constructor(
    ...
    * */
    ...
    override fun toString(): String {
        return "FetchConfiguration(appContext=$appContext, namespace='$namespace', concurrentLimit=$concurrentLimit, progressReportingIntervalMillis=$progressReportingIntervalMillis, loggingEnabled=$loggingEnabled, httpDownloader=$httpDownloader, globalNetworkType=$globalNetworkType, logger=$logger, autoStart=$autoStart, retryOnNetworkGain=$retryOnNetworkGain, fileServerDownloader=$fileServerDownloader, hashCheckingEnabled=$hashCheckingEnabled, fileExistChecksEnabled=$fileExistChecksEnabled, storageResolver=$storageResolver, fetchNotificationManager=$fetchNotificationManager, fetchDatabaseManager=$fetchDatabaseManager, backgroundHandler=$backgroundHandler, prioritySort=$prioritySort, internetCheckUrl=$internetCheckUrl, activeDownloadsCheckInterval=$activeDownloadsCheckInterval, createFileOnEnqueue=$createFileOnEnqueue, preAllocateFileOnCreation=$preAllocateFileOnCreation, maxAutoRetryAttempts=$maxAutoRetryAttempts, fetchHandler=$fetchHandler)"
    }
