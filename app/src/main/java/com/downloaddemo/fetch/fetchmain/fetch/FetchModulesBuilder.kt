...
import com.downloaddemo.fetch.fetchmain.database.FetchDatabaseManager
...
import com.downloaddemo.fetch.fetchmain.downloader.DownloadManagerCoordinator
import com.downloaddemo.fetch.fetchmain.downloader.DownloadManagerImpl
import com.downloaddemo.fetch.fetchmain.helper.DownloadInfoUpdater
import com.downloaddemo.fetch.fetchmain.helper.PriorityListProcessor
import com.downloaddemo.fetch.fetchmain.helper.PriorityListProcessorImpl
        ...
        return synchronized(lock) {
            ...
            val modules = if (holder != null) {
                ...
                val newHandlerWrapper = HandlerWrapper(
                    fetchConfiguration.namespace, fetchConfiguration.backgroundHandler
                )
                val liveSettings = LiveSettings(fetchConfiguration.namespace)
                val newDatabaseManager =
                    fetchConfiguration.fetchDatabaseManager ?: FetchDatabaseManagerImpl(
                ...
                val listenerCoordinator = ListenerCoordinator(
                    fetchConfiguration.namespace, groupInfoProvider, downloadProvider, mainUIHandler
                )
            ...
            fetchDatabaseManagerWrapper.delegate =
                object : FetchDatabaseManager.Delegate<DownloadInfo> {
                    override fun deleteTempFilesForDownload(downloadInfo: DownloadInfo) {
                        val tempDir =
                            fetchConfiguration.storageResolver.getDirectoryForFileDownloaderTypeParallel(
