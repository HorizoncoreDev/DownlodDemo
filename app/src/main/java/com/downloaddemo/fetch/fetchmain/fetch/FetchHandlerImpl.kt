...
import com.downloaddemo.fetch.fetchcore.BLOCKING_CALL_ON_UI_THREAD
...
import com.downloaddemo.fetch.fetchcore.FAILED_RENAME_FILE_ASSOCIATED_WITH_INCOMPLETE_DOWNLOAD
import com.downloaddemo.fetch.fetchcore.FILE_CANNOT_BE_RENAMED
import com.downloaddemo.fetch.fetchcore.FetchObserver
import com.downloaddemo.fetch.fetchcore.FileResource
import com.downloaddemo.fetch.fetchcore.FileServerDownloader
import com.downloaddemo.fetch.fetchcore.InterruptMonitor
import com.downloaddemo.fetch.fetchcore.Logger
import com.downloaddemo.fetch.fetchcore.REQUEST_DOES_NOT_EXIST
import com.downloaddemo.fetch.fetchcore.REQUEST_WITH_FILE_PATH_ALREADY_EXIST
...
import com.downloaddemo.fetch.fetchcore.getUniqueId
import com.downloaddemo.fetch.fetchcore.isFetchFileServerUrl
import com.downloaddemo.fetch.fetchmain.CompletedDownload
...
import com.downloaddemo.fetch.fetchmain.downloader.DownloadManager
...
import com.downloaddemo.fetch.fetchmain.helper.PriorityListProcessor
import com.downloaddemo.fetch.fetchmain.provider.GroupInfoProvider
import com.downloaddemo.fetch.fetchmain.util.canCancelDownload
import com.downloaddemo.fetch.fetchmain.util.canPauseDownload
import com.downloaddemo.fetch.fetchmain.util.canResumeDownload
import com.downloaddemo.fetch.fetchmain.util.canRetryDownload
import com.downloaddemo.fetch.fetchmain.util.defaultNoError
import com.downloaddemo.fetch.fetchmain.util.getCatalogServerRequestFromRequest
...
import com.downloaddemo.fetch.fetchmain.util.getServerRequestFromRequest
...
class FetchHandlerImpl(
    ...
    private fun prepareDownloadInfoForEnqueue(downloadInfo: DownloadInfo): Boolean {
        ...
        if (existingDownload == null) {
            ...
            } else if (existingDownload?.status == Status.COMPLETED && downloadInfo.enqueueAction == EnqueueAction.UPDATE_ACCORDINGLY) {
    ...
    override fun renameCompletedDownloadFile(id: Int, newFileName: String): Download {
        val download =
            fetchDatabaseManagerWrapper.get(id) ?: throw FetchException(REQUEST_DOES_NOT_EXIST)
    ...
    override fun getDownloadsInGroupWithStatus(
        groupId: Int, statuses: List<Status>
    ): List<Download> {
