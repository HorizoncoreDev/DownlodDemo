...
import com.downloaddemo.fetch.fetchmain.fetch.FetchImpl
import com.downloaddemo.fetch.fetchmain.fetch.FetchModulesBuilder
import com.downloaddemo.fetch.fetchmain.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import com.downloaddemo.fetch.fetchmain.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_REQUEST_UPDATED
...
interface Fetch {
     ...
     * */
    fun resume(
        ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<Error>? = null
    ): Fetch
    ...
    fun removeAllWithStatus(
        status: Status, func: Func<List<Download>>? = null, func2: Func<Error>? = null
    ): Fetch
    ...
    fun removeAllInGroupWithStatus(
        id: Int, statuses: List<Status>, func: Func<List<Download>>?, func2: Func<Error>? = null
    ): Fetch
     ...
     * */
    fun replaceExtras(
        id: Int, extras: Extras, func: Func<Download>? = null, func2: Func<Error>? = null
    ): Fetch
    ...
    fun renameCompletedDownloadFile(
        id: Int, newFileName: String, func: Func<Download>? = null, func2: Func<Error>? = null
    ): Fetch
     ...
     * */
    fun addListener(
        listener: FetchListener, notify: Boolean = DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
    ): Fetch
    ...
    fun getFetchFileServerCatalog(
        request: Request, func: Func<List<FileResource>>, func2: Func<Error>? = null
    ): Fetch
     ...
     * Use com.downloaddemo.fetch.fetchmain.NetworkType.GLOBAL_OFF to disable the global network preference.
     * The default value is com.downloaddemo.fetch.fetchmain.NetworkType.GLOBAL_OFF
    ...
    fun addActiveDownloadsObserver(
        includeAddedDownloads: Boolean = false, fetchObserver: FetchObserver<Boolean>
    ): Fetch
    ...
    companion object Impl {
        ...
        fun getDefaultInstance(): Fetch {
            return synchronized(lock) {
                val fetchConfiguration = defaultFetchConfiguration ?: throw FetchException(
