package com.downloaddemo.fetch.fetchmain.model
...
import com.downloaddemo.fetch.fetchmain.FetchGroupObserver
...
class FetchGroupInfo(
    override val id: Int = 0, override val namespace: String
) : FetchGroup {
