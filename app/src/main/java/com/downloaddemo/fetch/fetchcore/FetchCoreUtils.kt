...
fun getUniqueIdForFileNotFound(url: String, file: String): Int {
    return (url.hashCode() * 31) + (file.hashCode() * 31)
}
...
fun acceptRanges(
    ...
    return (contentLength > -1L && acceptsRanges) || (contentLength > -1L && transferValue?.lowercase(
        Locale.getDefault()
    ) != "chunked")
}
