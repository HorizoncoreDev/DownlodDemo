...
import com.downloaddemo.fetch.fetchcore.DEFAULT_PERSISTENT_TIME_OUT_IN_MILLISECONDS
import com.downloaddemo.fetch.fetchcore.DEFAULT_PROGRESS_REPORTING_INTERVAL_IN_MILLISECONDS
...
interface FetchFileServer {
    ...
    class Builder(
        ...
        private var fileResolver: FileResolver =
            object : FileResolver(context.applicationContext) {}
