...
@Entity(
    tableName = FileResourceInfoDatabase.TABLE_NAME, indices = [(Index(
        value = [FileResourceInfoDatabase.COLUMN_NAME], unique = true
...
class FileResourceInfo {
    ...
    override fun toString(): String {
        return "FileResourceInfo(id=$id, length=$length, file='$file', name='$name', extras='$extras', md5='$md5')"
    }
